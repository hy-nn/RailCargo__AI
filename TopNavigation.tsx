...
export const TopNavigation = ({
  ...
  const navTabs = [
    { label: "홈", to: isLoggedIn ? "/02_home_loggedin" : "/03_home_guest" },
    { label: "철도 운송", to: "/04_rail_nlp_input" },
      ...
      <div className="mx-auto flex h-[76px] w-full max-w-[1240px] items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          {isLoggedIn ? (
            ...
            <button
              type="button"
              onClick={() => navigate("/01_login")}
              className="text-[15px] font-semibold text-[#005bac] hover:underline"
            >
              로그인하기
            </button>
          )}
